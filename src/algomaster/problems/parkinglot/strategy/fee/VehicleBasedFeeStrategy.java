...
public class VehicleBasedFeeStrategy implements FeeStrategy {
    ...
    private static final Map<VehicleSize, BigDecimal> PER_SECOND_RATES = Map.of(
    ...
    public BigDecimal calculate(Ticket ticket) {
        ...
        BigDecimal price = PER_SECOND_RATES.get(vehicle.getSize()).multiply(BigDecimal.valueOf(seconds));
